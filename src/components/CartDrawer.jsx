...
function buildWhatsappUrl(cartItems) {
    const snos = cartItems
        .flatMap(({ item, qty }) => Array(qty).fill(item.Sno || item.Name))
        .join(", ");
    const text = encodeURIComponent(`Hi, I'd be interested in buying ${snos}`);
            ...
            <div className={`cart-drawer${open ? " cart-drawer-open" : ""}`} role="dialog" aria-label="Cart">
                <div className="cart-drawer-header">
                    <span className="cart-drawer-title">
                        Cart {cartCount > 0 && <span className="cart-drawer-count">{cartCount}</span>}
                    </span>
                    ...
                    <>
                        ...
                        <div className="cart-footer">
                            ...
                            <a
                                ...
                                href={buildWhatsappUrl(cartItems)}
                                target="_blank"
